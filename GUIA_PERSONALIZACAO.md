...
const DEFAULT_PIZZAS = [
  {
    ...
    preco_p: 29.9, // ← Preço Pequena (25cm)
    preco_m: 39.9, // ← Preço Média (30cm)
    preco_g: 49.9, // ← Preço Grande (35cm)
...
<div class="db-item">🛵 Entrega: <strong>R$ 5,00</strong></div>
← taxa real
<div class="db-item">⏱️ Tempo médio: <strong>40–55 min</strong></div>
← tempo real
<div class="db-item">📦 Pedido mínimo: <strong>R$ 30,00</strong></div>
← mínimo real
<div class="db-item">⭐ <strong>4.9</strong> (1.240 avaliações)</div>
← avalição real
```
...
🥇 Forma mais fácil — Copiar e colar o emoji
No arquivo frontend/app.js, procure a pizza que quer trocar:
javascript{ id:4, nome:'Portuguesa', emoji:'🍳', ...
Troque o emoji pelo que quiser:
javascript{ id:4, nome:'Portuguesa', emoji:'🍔', ...

😀 Sites para encontrar emojis que funcionam no Windows:
SiteLink🥇 Emojipediahttps://emojipedia.org🥈 GetEmojihttps://getemoji.com🥉 Coolsymbolhttps://coolsymbol.com/emojis

No site, clique no emoji → clique em Copy → cole no código

✅ Emojis 100% seguros para Windows (testados):
EmojiCódigoUso🍕pizzaQualquer pizza🧀queijoQuatro queijos🍅tomateMargherita, napolitana🌶️pimentaCalabresa, apimentada🐔frangoFrango catupiry🥩carneStrogonoff, carne🌮tacoMexicana🍌bananaBanana nevada🍓morangoNutella morango🍄cogumeloTrufa, premium🍳ovoPortuguesa🍖costelaChurrasco🦐camarãoFrutos do mar🥓baconBacon, americana🥚ovoPortuguesa🫑❌ NÃO USARNão funciona Win🫒❌ NÃO USARNão funciona Win🫚❌ NÃO USARNão funciona Win

⚡ Regra de ouro:

Se o emoji aparece normal aqui no chat, vai funcionar no sistema. Se aparecer como um quadradinho ☐ no Windows — não use!

🏪 Quem comprar:

Pizzarias independentes
Hamburguerias artesanais
Restaurantes por quilo
Lanchonetes
Dark kitchens
Mercadinhos e açougues

✅ O que você já tem para vender:
...
✅ Cardápio online para clientes
✅ Impressão de comanda
✅ Central WhatsApp
✅ Banco PostgreSQL robusto
✅ API REST completa

Você tem nas mãos um produto real, pronto para o mercado! 🚀🍕💰
_🍕 PizzaMaster Pro v2.0 — Guia de Personalização_
_Qualquer dúvida entre em contato com o desenvolvedor_
